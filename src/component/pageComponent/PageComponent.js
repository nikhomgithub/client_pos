...
const {dataState,dataFilter,dataInputState,captureEditData,bgColor}=props
...
const setPageNumber=(data)=>{
    setFilterData({...filterData,pageNumber:data,reloadData:true})
}
...
const renderGroup=()=>{
    ...
    return (
    <div className="w-100 h-100" style={{overflow:"auto",paddingBottom:"50px"}}>
        {
            renderFilter()
        }
